...
from proxy.services.auth_login import login_user
from proxy.services.auth_logout import logout_user
from proxy.services.auth_register import register_user
