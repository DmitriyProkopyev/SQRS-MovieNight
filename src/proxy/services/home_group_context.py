...
from proxy.services.home_component_vote_counts import (
    build_component_vote_counts,
)
from proxy.services.home_group_window import build_group_window
from proxy.services.home_group_winner import build_winner_id
from proxy.services.voting_rules import choose_winner
