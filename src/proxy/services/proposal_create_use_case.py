...
from proxy.services.proposal_response_builder import (
    build_created_proposal_response,
)
from proxy.services.proposal_room_validation import (
    ensure_existing_room,
)
from proxy.services.proposal_time_validation import (
    validate_proposal_time_bounds,
)
from proxy.services.proposal_title_charset import (
    ensure_printable_movie_title,
)
from proxy.services.proposal_title_length import (
    ensure_movie_title_length,
)
from proxy.services.proposal_title_normalization import (
